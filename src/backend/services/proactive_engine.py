    ...
    async def evaluate_commute(
        ...
        # Heavy Rain on cycling leg
            ...
            notification = ProactiveNotificationPayload(
                ...
                recommended_action=f"Shift departure to {shifted} or take CoveredLinkWay + Bus 84",
            ...
            notification = ProactiveNotificationPayload(
                ...
                reason="LTA crowd forecast indicates a high platform load at Punggol before conditions ease.",
                original_route_id="route-arjun-signature",
                suggested_route_id="route-proactive-offpeak",
                crowd_summary="Punggol MRT and Damai platform crowding is expected to ease after the peak window.",
            )
